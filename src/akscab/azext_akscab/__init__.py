...
from azext_akscab._help import helps  # pylint: disable=unused-import


class AkscabCommandsLoader(AzCommandsLoader):
    ...
    def load_arguments(self, command):
        from azext_akscab._params import load_arguments
        load_arguments(self, command)


COMMAND_LOADER_CLS = AkscabCommandsLoader
